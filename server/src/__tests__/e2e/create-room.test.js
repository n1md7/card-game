...
//     const { status, body } = await session.post(`/api/create-room`).send({
//       size,
//       isPublic,
//       name: myName,
//     });
...
//     await session1.post(`/api/create-room`).send({
//       size,
//       isPublic,
//       name: myName,
//     });
...
//     const r1 = await session1.post(`/api/create-room`).send({
//       size,
//       isPublic,
//       name: myName,
//     });
...
//     const r2 = await session1.post(`/api/create-room`).send({
//       size,
//       isPublic,
//       name: myName,
//     });
...
//     const r3 = await session1.post(`/api/join-room`).send({
//       id: r2.body.roomId,
//       name: myName,
//     });
...
//     await session1.get(`/api/leave-room`);
//     // join room
//     const r4 = await session1.post(`/api/join-room/`).send({
//       id: r2.body.roomId,
//       name: myName,
//     });
